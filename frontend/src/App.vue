<template>
  <div id="app">
    <img alt="img" src="@/assets/background.jpeg" class="bgimage" />
    <modal-window
    ...
    >
      ...
      >
        ...
        <template slot="Login">
          <p style="margin-top: 0">Login to create and post in threads.</p>
...
export default {
  ...
  methods: {
    ...
    audio.src = require("./assets/openingscene.mp3")
